 ...
 */
internal class AndroidConfigurationParser(private val requirementsProcessor: RequirementsProcessor) :
    ConfigurationParser<Int> {
    ...
    private fun parseRoot(data: JSONObject): PrinceOfVersionsConfig<Int> {
