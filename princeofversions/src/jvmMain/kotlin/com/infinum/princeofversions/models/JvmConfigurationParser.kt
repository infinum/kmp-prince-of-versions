 ...
 */
internal class JvmConfigurationParser(private val requirementsProcessor: RequirementsProcessor) :
    ...
    private fun parseRoot(data: JSONObject): PrinceOfVersionsConfig<String> {
