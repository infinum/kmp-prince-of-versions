...
For complete working examples, see the sample apps: [Android sample app](androidApp/), [JVM sample app](sampleApp/) and [iOS sample app](iosApp/) which demonstrate usage across all platforms. Additional examples and edge cases can be found in the test suites: [common tests](princeofversions/src/commonTest/), [Android tests](princeofversions/src/androidHostTest/), and [iOS tests](princeofversions/src/iosTest/).
